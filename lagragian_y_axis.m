...
x=pos(1)-Target.ModelData.re(1);
y=pos(2)-Target.ModelData.re(2);
z=pos(3)-Target.ModelData.re(3);
...
r=pos'-Target.ModelData.rs;

pot_s=-Target.ModelData.Primary.GravitationalConstant*r/(sqrt(sum(r.^2)))^3;

dif_pot=pot_s+pot_e-cross(Target.ModelData.Secondary.Rotation.w0,cross(Target.ModelData.Secondary.Rotation.w0,pos'));
